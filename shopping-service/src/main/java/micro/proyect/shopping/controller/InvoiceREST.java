package micro.proyect.shopping.controller;
...
import micro.proyect.shopping.service.InvoiceService;
...
public class InvoiceREST {
    ...
    public ResponseEntity<Invoice> createInvoice(@Valid @RequestBody Invoice invoice, BindingResult result) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(invoiceInDB);
    }

    // -------------------------------- Update Invoice --------------------------------
    @PutMapping(value = "/{id}")
    public ResponseEntity<?> updateInvoice(@PathVariable(name = "id") Long id, @RequestBody Invoice invoice) {
    ...
    public ResponseEntity<Invoice> delteInvoice(@PathVariable("id") Long id) {
